...
export async function render(mount) {
  ...
  <div class="note bad"><span class="tag">split integrity</span><div class="bd">
    The split is stratified <b>by year and scene</b>, not by night. Radar scans repeat about every
    30 minutes through a night, so consecutive scans of the same plume are near duplicates.
    ...
    Test scores therefore measure interpolation within known nights, not generalisation to a new night.
    <br><b>What would fix it:</b> regenerate the manifest grouping by <code>night</code> before assigning
    splits, then retrain. The code already carries a <code>night</code> column for every positive scene.
  </div></div>
